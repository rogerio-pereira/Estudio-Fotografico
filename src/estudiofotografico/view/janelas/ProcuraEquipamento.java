 ...
 */
public class ProcuraEquipamento extends javax.swing.JDialog implements KeyListener, ContainerListener{

    /** Creates new form ProcuraEquipamento */
    public ProcuraEquipamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents()
    {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(comboMarca, javax.swing.GroupLayout.Alignment.TRAILING, 0, 219, Short.MAX_VALUE)
        ...
        tabelaEquipamento.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                "Codigo", "Nome", "Marca", "Tipo", "Numero de Serie"
            }
        )
        {
    ...
    {//GEN-HEADEREND:event_botaoPesquisarActionPerformed
        ...
        List<Equipamentos> lista = control.getEquipamentos	(
            this.getCodigo(),
            this.getNome(),
            this.getMarca(),
            this.getTipo(),
    ...
    {//GEN-HEADEREND:event_botaoSelecionarActionPerformed
        if(tabelaEquipamento.getSelectedRow() != -1)
        {
            ...
            if(janela.getTitle() == "Cadastro de Equipamento")
            {
                janelaCadastroEquipamentos = (CadastroEquipamentos) this.getParent();
                janelaCadastroEquipamentos.codigo = Long.parseLong(tabelaEquipamento.getValueAt(tabelaEquipamento.getSelectedRow(), 0).toString());
                janelaCadastroEquipamentos.limpaTela();
                janelaCadastroEquipamentos.getEquipamentoByCodigo();
            }
    ...
    {//GEN-HEADEREND:event_jButton1ActionPerformed
		...
		janelaPesquisaFornecedor.setJanelaProcuraEquipamento(this);
	...
	private void configuraTabela()
	{
		...
		tabelaEquipamento.getColumnModel().getColumn(0).setCellRenderer(alinhamento);
		
		tabelaEquipamento.getColumnModel().getColumn(0).setPreferredWidth(80); 
		tabelaEquipamento.getColumnModel().getColumn(1).setPreferredWidth(150); 
		tabelaEquipamento.getColumnModel().getColumn(2).setPreferredWidth(100); 
		tabelaEquipamento.getColumnModel().getColumn(3).setPreferredWidth(100); 
		tabelaEquipamento.getColumnModel().getColumn(4).setPreferredWidth(120); 
	}
    /*
	 * Método apagaTabela
	 * Apaga a tabela
	...
	public void apagaTabela()
	{
		...
		while(tabelaEquipamento.getRowCount() > 0)
			modelo.removeRow(0);
	}
	 ...
	 */
	public void insereDados(List<Equipamentos> lista)
	{
		for(Equipamentos equipamento: lista)
		{
			DefaultTableModel modelo = (DefaultTableModel) tabelaEquipamento.getModel();
			modelo.addRow(new String[]	{
											equipamento.getCodigo().toString(),
											equipamento.getEquipamento(),
											equipamento.getMarca().getMarca(),
											equipamento.getTipo().getTipo(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProcuraEquipamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProcuraEquipamento dialog = new ProcuraEquipamento(new javax.swing.JFrame(), true);
    ...
    {
        if((this.comboTipo.getSelectedIndex() == -1) || (this.comboTipo.getSelectedIndex() == 0))
			return null;
		else
    ...
    private estudiofotografico.control.ControladorEquipamentos  control;
	private Long                                                codigo;
	private String                                              nome;
