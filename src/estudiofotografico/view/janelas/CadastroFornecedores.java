...
import estudiofotografico.model.EmailsFornecedores;
import estudiofotografico.model.Fornecedores;
import estudiofotografico.model.TelefonesFornecedores;
...
public class CadastroFornecedores extends javax.swing.JFrame implements KeyListener, ContainerListener{
	...
	public void getFornecedorByCodigo()
	{
        ...
        this.fornecedores	= control.getFornecedorByCodigo(this.codigo);
        
        //Insere os dados na janela
		this.textoCodigo.setText(this.codigo.toString());
		this.textoNome.setText(this.fornecedores.getNome());
		if(this.fornecedores.getPessoa() == true)
		{
			this.radioPessoaFisica.doClick();
			this.textoRG.setText(this.fornecedores.getRg());
			this.textoCPF.setText(this.fornecedores.getCpf());
			this.textoNascimento.setCalendar(this.fornecedores.getNascimento());
			if(this.fornecedores.getSexo() == true)
				this.radioMasculino.doClick();
			else if(this.fornecedores.getSexo() == false)
				this.radioFeminino.doClick();
		}
		else if(this.fornecedores.getPessoa() == false)
		{
			this.radioPessoaJuridica.doClick();
			this.textoCNPJ.setText(this.fornecedores.getCnpj());
			this.textoCPFResponsavel.setText(this.fornecedores.getCpfResponsavel());
			this.textoRGResponsavel.setText(this.fornecedores.getRgResponsavel());
			this.textoResponsavel.setText(this.fornecedores.getResponsavel());
		}
		this.textoEndereco.setText(this.fornecedores.getEndereco());
		this.textoNumero.setText(String.valueOf(this.fornecedores.getNumero()));
		this.textoBairro.setText(this.fornecedores.getBairro());
		this.textoComplemento.setText(this.fornecedores.getComplemento());
		this.textoCidade.setText(this.fornecedores.getCidade());
		...
		//E-mails
		this.emails = this.fornecedores.getEmails();
...
private void textoObsKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textoObsKeyTyped
    ...
    {//GEN-HEADEREND:event_botaoSalvarActionPerformed
		...
		if(this.validaCampos())
		{
			...
			if(this.textoCodigo.getText().equals("** NOVO **"))
				controlBD.fornecedores = new Fornecedores();
			else
				controlBD.fornecedores = control.getFornecedorByCodigo(Long.parseLong(this.textoCodigo.getText()));

			//Definindo os dados
			controlBD.fornecedores.setNome(this.textoNome.getText());
			if(this.radioPessoaFisica.isSelected())
				controlBD.fornecedores.setPessoa(true);
			else if(this.radioPessoaJuridica.isSelected())
				controlBD.fornecedores.setPessoa(false);
			controlBD.fornecedores.setRg(this.textoRG.getText());
			controlBD.fornecedores.setCpf(this.textoCPF.getText());
			controlBD.fornecedores.setNascimento(this.textoNascimento.getCalendar());
			if(this.radioMasculino.isSelected())
				controlBD.fornecedores.setSexo(true);
			if(this.radioFeminino.isSelected())
				controlBD.fornecedores.setSexo(false);
			controlBD.fornecedores.setCnpj(this.textoCNPJ.getText());
			controlBD.fornecedores.setCpfResponsavel(this.textoCPFResponsavel.getText());
			controlBD.fornecedores.setRgResponsavel(this.textoRGResponsavel.getText());
			controlBD.fornecedores.setResponsavel(this.textoResponsavel.getText());
			controlBD.fornecedores.setEndereco(this.textoEndereco.getText());
			controlBD.fornecedores.setNumero(Integer.parseInt(this.textoNumero.getText()));
			controlBD.fornecedores.setBairro(this.textoBairro.getText());
			controlBD.fornecedores.setComplemento(this.textoComplemento.getText());
			controlBD.fornecedores.setCidade(this.textoCidade.getText());
			...
			controlBD.fornecedores.setTelefones(telefones);
			...
			controlBD.fornecedores.setEmails(emails);
			
			//Atualizando banco
			if(this.textoCodigo.getText().equals("** NOVO **"))
				controlBD.cadastrar(controlBD.fornecedores, (JFrame)this);
			else
				controlBD.atualizar(controlBD.fornecedores, (JFrame)this);
    ...
    {//GEN-HEADEREND:event_botaoExcluirActionPerformed
		...
		controlBD.apagar(codigo, controlBD.fornecedores, (JFrame)this);
