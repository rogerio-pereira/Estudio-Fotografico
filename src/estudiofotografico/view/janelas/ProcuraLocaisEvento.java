 ...
 */
public class ProcuraLocaisEvento extends javax.swing.JDialog implements KeyListener, ContainerListener{

    /** Creates new form ProcuraLocaisEvento */
    public ProcuraLocaisEvento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents()
    {
        ...
        setTitle("Procura Locais de Evento");
        setAlwaysOnTop(true);
        setModal(true);
        ...
        tabelaLocais.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                "Codigo", "Nome", "Endereço", "Cidade", "Site", "Responsável"
            }
        )
        {
        ...
        tabelaLocais.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
    ...
    {//GEN-HEADEREND:event_botaoPesquisarActionPerformed
        ...
        List<LocaisEventos> lista = control.getLocaisEventoBusca(
																	this.getCodigo(),
																	this.getNome(),
																	this.getResponsavel(),
																	this.getSite()
    ...
    {//GEN-HEADEREND:event_botaoSelecionarActionPerformed
        if(tabelaLocais.getSelectedRow() != -1)
        {
            JFrame janela = (JFrame) this.getParent();
            if(janela.getTitle() == "Cadastro Locais de Eventos")
            {
                janeCadastroLocaisEventos = (CadastroLocaisEventos) this.getParent();
                janeCadastroLocaisEventos.codigo = Long.parseLong(tabelaLocais.getValueAt(tabelaLocais.getSelectedRow(), 0).toString());
                janeCadastroLocaisEventos.limpaTela();
                janeCadastroLocaisEventos.getProdutoByCodigo();
            }
			else if(janela.getTitle() == "Vendas")
			{
				janelaVendas = (Vendas) this.getParent();
				janelaVendas.setLocalByCod(Long.parseLong(tabelaLocais.getValueAt(tabelaLocais.getSelectedRow(), 0).toString()));
			}
			else if(janela.getTitle() == "Procura Vendas")
			{
				janelaProcuraVendas = (ProcuraVendas) this.getParent();
				janelaProcuraVendas.setLocalByCod(Long.parseLong(tabelaLocais.getValueAt(tabelaLocais.getSelectedRow(), 0).toString()));
			}
	...
	private void configuraTabela()
	{
		...
		tabelaLocais.getColumnModel().getColumn(0).setCellRenderer(alinhamento);
		
		tabelaLocais.getColumnModel().getColumn(0).setPreferredWidth(80); 
		tabelaLocais.getColumnModel().getColumn(1).setPreferredWidth(200); 
		tabelaLocais.getColumnModel().getColumn(2).setPreferredWidth(200); 
		tabelaLocais.getColumnModel().getColumn(3).setPreferredWidth(150); 
		tabelaLocais.getColumnModel().getColumn(4).setPreferredWidth(200); 
		tabelaLocais.getColumnModel().getColumn(5).setPreferredWidth(200); 
	}
	...
	{
		DefaultTableModel modelo = (DefaultTableModel) tabelaLocais.getModel();
		while(tabelaLocais.getRowCount() > 0)
			modelo.removeRow(0);
	}
	 ...
	 */
	public void insereDados(List<LocaisEventos> lista)
	{
		for(LocaisEventos local: lista)
		{
			DefaultTableModel modelo = (DefaultTableModel) this.tabelaLocais.getModel();
			modelo.addRow(new String[]	{
											local.getCodigo().toString(),
											local.getNome(),
											local.getEndereco(),
											local.getCidade(),
											local.getSite(),
											local.getResponsavel()
										});
		}
	}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProcuraLocaisEvento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProcuraLocaisEvento dialog = new ProcuraLocaisEvento(new javax.swing.JFrame(), true);
	...
	{
		if(this.textoResponsavel.getText().isEmpty())
			return null;
		else
			return this.textoResponsavel.getText();
	}


	public String getSite ()
	{
		if(this.textoSite.getText().isEmpty())
			return null;
		else
			return this.textoSite.getText();
	}
	...
	private CadastroLocaisEventos	janeCadastroLocaisEventos;
