    ...
    {//GEN-HEADEREND:event_botaoSelecionarActionPerformed
        if(tabelaClientes.getSelectedRow() != -1)
        {
			...
			else if(janela.getTitle() == "Vendas")
			{
				...
				janelaVendas.setClienteByCod(Long.parseLong(tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(), 0).toString()));
			}
			else if(janela.getTitle() == "Procura Vendas")
			{
				janelaProcuraVendas = (ProcuraVendas) this.getParent();
				janelaProcuraVendas.setClienteByCod(Long.parseLong(tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(), 0).toString()));
			}
			else if(janela.getTitle() == "Gerador de Recibo")
			{
				janelaRecibos = (Recibos) this.getParent();
				janelaRecibos.setClienteByCod(Long.parseLong(tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(), 0).toString()));
			}
