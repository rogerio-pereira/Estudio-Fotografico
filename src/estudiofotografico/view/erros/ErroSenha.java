 ...
 */
public class ErroSenha extends javax.swing.JDialog implements KeyListener, ContainerListener{

    /** Creates new form ErroLogin */
    public ErroSenha(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/estudiofotografico/view/img/accept.png"))); // NOI18N
        jButton1.setText("OK");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErroSenha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErroSenha dialog = new ErroSenha(new javax.swing.JFrame(), true);
