 ...
 */
public class SucessoAlterar extends javax.swing.JDialog implements KeyListener, ContainerListener
{
    /** Creates new form ErroAbrirConexao */
    public SucessoAlterar (java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("Alterado com sucesso!");
...
private void botaoOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoOKActionPerformed
    ...
    public static void main (String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(SucessoAlterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run ()
            {
                SucessoAlterar dialog = new SucessoAlterar(new javax.swing.JFrame(), true);
