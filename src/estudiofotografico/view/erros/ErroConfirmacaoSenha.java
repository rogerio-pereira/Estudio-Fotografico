 ...
 * Data Criação: Feb 21, 2014
 */
public class ErroConfirmacaoSenha extends javax.swing.JDialog implements KeyListener, ContainerListener{

    /** Creates new form erroCampoEmBranco */
    public ErroConfirmacaoSenha(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("Senha diferente da Confirmação");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErroConfirmacaoSenha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErroConfirmacaoSenha dialog = new ErroConfirmacaoSenha(new javax.swing.JFrame(), true);
