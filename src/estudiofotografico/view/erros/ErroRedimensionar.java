 ...
 */
public class ErroRedimensionar extends javax.swing.JDialog implements KeyListener, ContainerListener
{
    /** Creates new form ErroAbrirConexao */
    public ErroRedimensionar (java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("Erro ao redimensionar Imagens!");
...
private void botaoOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoOKActionPerformed
    ...
    public static void main (String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(ErroRedimensionar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run ()
            {
                ErroRedimensionar dialog = new ErroRedimensionar(new javax.swing.JFrame(), true);
