 ...
 */
public class ErroCampoEmBranco extends javax.swing.JDialog implements KeyListener, ContainerListener{

    /** Creates new form erroCampoEmBranco */
    public ErroCampoEmBranco(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("Campo em branco");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErroCampoEmBranco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErroCampoEmBranco dialog = new ErroCampoEmBranco(new javax.swing.JFrame(), true);
