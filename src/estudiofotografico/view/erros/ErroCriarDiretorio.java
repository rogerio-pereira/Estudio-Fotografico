 ...
 */
public class ErroCriarDiretorio extends javax.swing.JDialog implements KeyListener, ContainerListener
{
    /** Creates new form ErroAbrirConexao */
    public ErroCriarDiretorio (java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("Erro ao criar diretório!");
...
private void botaoOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoOKActionPerformed
    ...
    public static void main (String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(ErroCriarDiretorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run ()
            {
                ErroCriarDiretorio dialog = new ErroCriarDiretorio(new javax.swing.JFrame(), true);
