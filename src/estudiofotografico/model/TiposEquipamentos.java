...
@NamedQueries
({
	@NamedQuery(name = "TipoEquipamento.findAll", query = "SELECT tipo FROM TiposEquipamentos ORDER BY tipo ASC"),
	@NamedQuery(name = "TipoEquipamento.findOne", query = "SELECT codigo FROM TiposEquipamentos WHERE tipo = ?0")
})
