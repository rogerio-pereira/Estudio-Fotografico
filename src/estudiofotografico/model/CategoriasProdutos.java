...
@NamedQueries
({
	@NamedQuery(name = "CategoriaProduto.findAll", query = "SELECT categoria FROM CategoriasProdutos ORDER BY categoria ASC"),
	@NamedQuery(name = "CategoriaProduto.findOne", query = "SELECT c.codigo FROM CategoriasProdutos c WHERE c.categoria = ?0")
})
